...
- 先将例子所在的选项从选项列表中划去
- 不要先看选项，而要先读文章，读一段话，做一道题
- 读每段话时，通读全段，同时注意寻找段落的主题句
  主题句的特征：
  - 段落的第一句中包含让步状语，肯定是主题句(Although A, B; While A, B; Despite A, B)
  - 如果段落的下一句为如下句型，则肯定是主题句
  ...
  - 如果段落的第一句是问句，则它肯定不是主题句，而第二句是主题句。
  - 如果段落的第一句是如下句型，则它肯定是主题句。
    not only A， but also B.
  - 如果段落中某句话是举例子的句子，则它肯定不是主题句，而它前面的那个句子是主题句。
  - 如果段落中某句话是如下句型，则它肯定是主题句。
    A shows that B.
    A showing that B.
    A suggests that B.
  - 通读全段后，如果段落中没有明显的主题句，这时，如果读懂了全段的主要意思，就把它归纳总结一下。如果没有读懂，可以把段落的第一句看作是主题句。第一句是主题句的概率超过 50%，所以应该重点理解第一句话的意思。
- 在选项列表中依次看各选项，正确选项是主题句的改写
- 某段的答案确定后，将它的选项从选项列表中划去

> 注意事项：
>
> 1. 如果答案不确定，则先将可能正确的选项全部选出
> 2. 两个选项，雌雄难辨，优先选择后一个选项
> 3. 包含下列词的选项，是正确选项的可能性很大
